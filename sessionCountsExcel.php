<?php
// Filtering out all ringers where administrator = 1
...
$sql = "select fname, lname, email, count(0) AS Count from v_schedule_with_phone_administrator where administrator = 0  ";
